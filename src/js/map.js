window.VTC = {
    "ditu": {
        "normal": {"version": "087", "updateDate": "20150902"},
...
window.BMAP_AUTHENTIC_KEY = "lcvsPMNypyVAFpko5zEhETem";
(function () {
    function aa(a) {
        throw a;
    }
    ...
    w.extend(Be.prototype, {
        kp: function (a) {
            ...
            this.Dc = G() ? new Ae(this.Nj, {ao: q, nx: o, Wh: q, li: q, Rm: q, SD: o, Wv: o, Sw: o}) : new Fe(this.Nj)
        }, J: function () {
    ...
    var jf = Dd.prototype;
    R(jf, {show: jf.show, hide: jf.J, setTypes: jf.JE, setLocation: jf.Im, search: jf.search, setInputValue: jf.Ox});
    R(mb.prototype, {});
    var kf = Bd.prototype;
    R(kf, {get: kf.get});
    R($b.prototype, {});
